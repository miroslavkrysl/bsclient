...
public class RestoreStateGame extends RestoreState {
    ...
    public RestoreStateGame(Nickname opponent, Who onTurn, Hits playerBoard, Hits opponentBoard, ShipsPlacements sunkenShips) {
    ...
    public static RestoreStateGame deserialize(PayloadDeserializer deserializer) throws DeserializeException {
        ...
        return new RestoreStateGame(opponent, onTurn, playerBoard, opponentBoard, sunkenShips);
    }
}
